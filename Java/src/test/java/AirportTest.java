...
public class AirportTest {
    ...
    public void testGetTransportMilitaryPlanes() {
        ...
        boolean planeTransportMilitaryPlanes = false;
        for (MilitaryPlane militaryPlane : transportMilitaryPlanes) {
            if ((militaryPlane.getType() == MilitaryType.TRANSPORT)) {
                planeTransportMilitaryPlanes = true;
                break;
            }
        }
        Assert.assertTrue(planeTransportMilitaryPlanes);
    }
    ...
    @Test
    public void testAirportSortByMaxLoadCapacity() {
        Airport airport = new Airport(planes);
    ...
    public void testHasAtLeastOneBomberInMilitaryPlanes() {
        ...
        boolean planeMilitaryTypeIsBomber = false;
        for (MilitaryPlane militaryPlane : bomberMilitaryPlanes) {
            if ((militaryPlane.getType() == MilitaryType.BOMBER)) {
                planeMilitaryTypeIsBomber = true;
            }
            else {
